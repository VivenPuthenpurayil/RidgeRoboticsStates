...
public class BlueDepot extends AutonomousControl {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            switch (position){
                case 0:
                    rob.driveTrainEncoderMovement(0.9, 0.25, 5, 0, Rover.movements.bl);

                    rob.driveTrainEncoderMovement(0.7, 2.75, 5, 30, Rover.movements.bl);
                    rob.turn(45, Rover.turnside.cw, 0.7, Rover.axis.center);
                    while (rob.BLU.getDistance(DistanceUnit.INCH) > 4){
                        rob.driveTrainMovement(0.8, Rover.movements.left);
                    }
                    ...
                    rob.driveTrainEncoderMovement(0.8, 7, 5, 30, Rover.movements.backward);
                    break;
                case 1:
                default:
                    ...
                    rob.turn(45, Rover.turnside.cw, 0.8, Rover.axis.center);
                    while (rob.BLU.getDistance(DistanceUnit.INCH) > 4){
                        rob.driveTrainMovement(0.4, Rover.movements.left);
                    }
                    rob.driveTrainEncoderMovement(0.7, 2.5, 5, 0, Rover.movements.forward);
                    rob.stopDrivetrain();
                    //rob.anyMovementTime(0.2, Rover.movements.armDown, 100, rob.arm);
                    ...
                    break;
                case 2:
                    rob.driveTrainEncoderMovement(0.7, 1, 5, 30, Rover.movements.forward);
                    ...
                    // rob.anyMovementTime(0.2, Rover.movements.armDown, 100, rob.arm);
                    rob.anyMovementTime(0.8, Rover.movements.linearOut, 1000, rob.linear);
                    rob.anyMovementTime(0.8, Rover.movements.collectorCollect, 2000, rob.collector);
                    rob.anyMovementTime(0.8, Rover.movements.linearIn, 1000, rob.linear);
                    rob.driveTrainEncoderMovement(0.8, 4.25, 5, 30, Rover.movements.backward);
